...
\begin{center}
  {\fontsize{12}{14}\selectfont\sffamily\color{mayalavender}
    \textbf{A C\nolinebreak\hspace{-.05em}\raisebox{.2ex}{\small{++}}26 TERMINAL UI LIBRARY}\par}
  \vspace{0.4cm}
  {\fontsize{10}{12}\selectfont\sffamily\color{mayagrey}
    from ANSI bytes to compile-time UI trees\par}
\end{center}

\vspace{2.5cm}

\begin{center}
  {\fontsize{96}{108}\selectfont\sffamily\bfseries\color{mayablue} The}\\[0.1em]
  {\fontsize{144}{160}\selectfont\sffamily\bfseries\color{mayalight} maya}\\[0.1em]
  {\fontsize{96}{108}\selectfont\sffamily\bfseries\color{mayablue} Book}
\end{center}

\vspace{1.8cm}

% Decorative ASCII frame --- the library's own visual language
\begin{center}
  \ttfamily\fontsize{11}{14}\selectfont
  \begin{tabular}{@{}l@{}}
    \color{mayablue}.--------------------------------------------.\\
    \color{mayablue}|\color{mayalight}~~a complete tour of the maya library~~~~~~\color{mayablue}|\\
    \color{mayablue}|\color{mayagrey}~~from the byte up, in modern C++26~~~~~~~~\color{mayablue}|\\
    \color{mayablue}`--------------------------------------------'
  \end{tabular}
\end{center}
...
\begin{center}
  ...
  \vspace{0.4em}
  {\fontsize{9}{11}\selectfont\sffamily\color{mayagrey}
