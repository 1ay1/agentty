...
// Appearance is NOT a category. It is a form pane of its own (Ctrl+K →
// Appearance, msg::OpenAppearance) because it is grouped and has per-row
// help, neither of which this flat list can express.
