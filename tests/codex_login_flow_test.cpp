...
//
// Locks the two pure transitions of the first-class in-app ChatGPT sign-in:
//
//   A. LoginPickMethod{'3'} from the Picking modal → ChatGptWaiting (and a
//      non-none Cmd: the async loopback login is launched).
